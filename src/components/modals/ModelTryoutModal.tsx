      ...
      >
        ...
        <div className="px-5 py-3 border-b border-slate-200/80 bg-slate-50/80 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setTryoutModel(null)}
              className="p-1.5 rounded-xl hover:bg-slate-200/60 text-slate-400 hover:text-slate-800 transition cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-white border border-slate-200/90 hover:border-indigo-300 text-slate-900 text-xs font-extrabold shadow-2xs hover:shadow-xs flex items-center gap-2 transition cursor-pointer"
            >
